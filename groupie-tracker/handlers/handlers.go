...
func init() {
	var err error
	All, err = template.ParseFiles("ui/htmlfiles/error.html", "ui/htmlfiles/index.html", "ui/htmlfiles/more-info.html", "ui/htmlfiles/explore.html", "ui/htmlfiles/contact.html")
	if err != nil {
		log.Fatal(err)
	}
}
...
func SearchHandler(w http.ResponseWriter, r *http.Request) {
	...
	err := All.ExecuteTemplate(w, "explore.html", res)
	if err != nil {
...
func ExploreHandler(w http.ResponseWriter, r *http.Request) {
	...
	myResponse.AllArtists = result
	myResponse.FoundArtists = result
	err := All.ExecuteTemplate(w, "explore.html", myResponse)
	if err != nil {
		errorHeader(w, http.StatusInternalServerError)
		return
	}
...
func ContactHandler(w http.ResponseWriter, r *http.Request) {
	...
	err := All.ExecuteTemplate(w, "contact.html", nil)
	if err != nil {
		errorHeader(w, http.StatusInternalServerError)
		return
	}
